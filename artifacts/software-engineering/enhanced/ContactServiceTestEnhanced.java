...
// Date: 2026-03-22
// Description: Unit tests for ContactService.java to verify add, delete, update, and retrieval functionality.
...
public class ContactServiceTest {
	...
	void testUpdateAllFields() {
		Contact contact = new Contact("1234567890", "John", "Smith", "1234567890", "1234 Not Real Blvd.");
		contactService.addContact(contact);
		assertTrue(contactService.updateLastName("1234567890", "Doe"));
		assertTrue(contactService.updateNumber("12345567890", "0987654321"));
		assertTrue(contactService.updateAddress("1234567890", "456 Fictional St."));
		Contact updated = contactService.getContact("1234567890");
		assertEquals("Doe", updated.getLastName());
		assertEquals("0987654321", updated.getNumber());
		assertEquals("456 Fictional St.", updated.getAddress());
	}
